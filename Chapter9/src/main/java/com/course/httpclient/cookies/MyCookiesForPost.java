...
public class MyCookiesForPost {
    ...
    public void beforeTest(){
        bundle = ResourceBundle.getBundle("application", Locale.CHINA);//不用写完，会自动找到resource下面的application配置文件
    ...
    public void testGetCookies() throws IOException {
        ...
        //获取cookies信息，cookiestore存储cookies信息
    ...
    public void testPostMethod() throws IOException {
        ...
        //处理结果，就是判断返回结果是否符合预期
        //第1：将返回的相应结果字符串转化为json对象
        JSONObject resultJosn = new JSONObject(result);
        //获取到结果值
        String success = (String) resultJosn.get("msg");
